...
export default class animationUI {
    ...
    public applyRandomAnimation(target: any[], x: number, y: number, onComplete?: Function) {
        ...
        if (randomAnimation === 'grow') {
            ...
            this.scene.tweens.add({
                targets: target,
                scaleX: { from: 1, to: -1 }, // Flips horizontally
                duration: animationDuration,
                yoyo: true,
                repeat: 3,
                ease: 'Sine.easeInOut',
            ...
            this.scene.tweens.add({
                targets: target,
                scaleY: { from: 1, to: -1 }, // Flips vertically
                duration: animationDuration,
                yoyo: true,
                repeat: 3,
                ease: 'Sine.easeInOut',
            ...
            this.scene.tweens.add({
                targets: target,
                alpha: { from: 1, to: 0.2 }, // Fades in and out
                duration: animationDuration,
                yoyo: true,
                repeat: 5,
                ease: 'Sine.easeInOut',
            ...
            target.forEach(obj => {
                this.scene.tweens.add({
                    targets: obj,
                    alpha: { from: 1, to: 0.3 }, // Fade effect
                    y: obj.y - 20, // Float upwards
                    duration: animationDuration,
                    yoyo: true,
                    repeat: 3,
                    ease: 'Sine.easeInOut',
            ...
            this.scene.tweens.add({
                targets: target,
                scaleX: { from: 1, to: 0.2 }, // Squish horizontally
                scaleY: { from: 1, to: 2 },   // Stretch vertically
                duration: animationDuration,
                yoyo: true,
                repeat: 3,
                ease: 'Sine.easeInOut',
            ...
            this.scene.tweens.add({
                targets: target,
                angle: 360, // Spin for extra warp effect
                duration: animationDuration,
        ...
        if (randomColorAnimation === 'colorShift') {
            ...
            this.scene.tweens.add({
                ...
                duration: animationDuration,
                ease: 'Quad.easeOut',
                yoyo: true, // Shrinks back after explosion
                repeat: 4,
                onComplete: () => {
                    this.scene.tweens.add({
                        targets: target,
